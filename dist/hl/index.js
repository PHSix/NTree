...
exports.init = exports.namespace_id = void 0;
exports.namespace_id = 0;
async function init(nvim) {
    exports.namespace_id = await nvim.createNamespace('NodeTreeNameSpace');
    await setHlGroup(nvim);
}
exports.init = init;
async function setHlGroup(nvim) {
    const hl_queue = [];
